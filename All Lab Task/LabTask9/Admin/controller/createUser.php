...
if (isset($_POST['addmovie'])) {
    ...
    $data['cast'] = $_POST['mcast'];
    $data['duration'] = $_POST['mduration'];
    $data['rating'] = $_POST['mrating'];

    $data['story'] = $_POST['mstory'];
    $data['mimage'] = basename($_FILES["image"]["name"]);
    ...
    if (addMovie($data)) {
      echo 'Successfully added!!';
      echo "<br>";
      echo 'now <a href="../view/managemovie.php">Movies</a>';
    } else {
      echo 'You are not allowed to access this page.';
    }
  }
  ...
  if (isset($_POST['addShow'])) {
    ...
    $data['cast'] = $_POST['mname'];
    $data['duration'] = $_POST['show'];
    $data['rating'] = $_POST['ntickets'];
    if (addShow($data)) {
        echo 'Successfully added!!';
        echo "<br>";
        echo 'now <a href="../view/manageshow.php">Back</a>';
      } else {
        echo 'You are not allowed to access this page.';
      }
  }
